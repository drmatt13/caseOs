...
### `cdk-app/.env`
`CDK_APP_NAME`, `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`, `PROD_CERTIFICATE_ARN`, `LOCAL_DEV_URL`, `PROD_URL`, `LAMBDA_ARCHITECTURE`, `STRIPE_PUBLISHABLE_KEY`, `STRIPE_SECRET_KEY`
