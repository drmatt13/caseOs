...
const SettingsModal = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`top-12 h-max max-h-[calc(100vh-6rem)] /w-lg max-w-full overflow-hidden text-md relative z-20 border rounded-xl bg-white/90 backdrop-blur-sm border-black/15 shadow-md transition-all ${
          modal
