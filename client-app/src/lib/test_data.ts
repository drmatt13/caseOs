...
export const testCaseIntake: CaseIntake = {
  ...
  importantFilingsDeadlinesAndIncidents:
    "Important events include the June 17, 2025 Notice to Quit, the August 5, 2025 certified request asking Plaintiffs to file promptly so mitigation options could remain available, September 2025 agreement-to-vacate discussions tied to a no-fault filing deadline, the October 14, 2025 summary process filing, the November 25, 2025 Answer and Counterclaims with discovery requests, the January 5, 2026 motion to compel, the January 22, 2026 pretrial conference and meet-and-confer order, the March 26, 2026 renewed motion to compel, and Plaintiffs' April 3, 2026 supplemental discovery responses.",
  ...
  yourObjective:
    "The objective is to defeat or reduce Plaintiffs' claims for possession and money damages, prove the broader factual context beyond simple nonpayment, establish Defendants' defenses and counterclaims, and show that Plaintiffs' own conduct increased the damages they now seek. A related objective is to organize the matter into a durable workspace that preserves facts, issues, arguments, timelines, and record gaps for litigation support.",
  ...
  desiredOutcome:
    "The ideal outcome is a defense verdict or materially reduced recovery for Plaintiffs, recognition of Defendants' affirmative claims and defenses, and a factual finding that the case cannot fairly be reduced to unpaid rent alone. A favorable outcome would also include acknowledgment that Plaintiffs failed to act reasonably once hardship and mitigation consequences were known.",
  ...
  parties:
    "Plaintiffs: Faxon Commons / property management and landlord-side entities associated with the tenancy. Defendants: Matthew Sweeney and household members residing in the unit.",

  attorneys:
    "Defendants are appearing pro se. Plaintiffs are represented by counsel from SLG Legal Group.",

  witnessesAndAnticipatedTestimony:
    "Matthew Sweeney is expected to testify regarding move-in conditions, repeated in-person complaints, inconsistent extermination and maintenance responses, financial hardship communications, reliance on representations about filing and assistance pathways, the July 24, 2025 entry incident, and discovery deficiencies. Defendant household witnesses are expected to testify regarding day-to-day conditions in the apartment, cleaning and mitigation efforts, the practical effect of infestation and entry on the household, and communications with management. Plaintiffs' side may present management or records-based witnesses to testify about rent, notices, portal records, maintenance, and case handling.",
