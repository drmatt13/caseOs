...
export type MyWorkspaceInvitationsQuery = { myWorkspaceInvitations: Array<{ id: string | null, role: MembershipRole | null, expiresAt: string | null, createdAt: string | null, invitedBy: { displayName: string | null, firstName: string | null, lastName: string | null, email: string | null } | null, workspace: { id: string | null, name: string | null } | null }> | null };
